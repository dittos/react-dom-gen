...
describe('ReactServerRendering', () => {
  ...
  describe('renderToString', () => {
    it('should generate simple markup', () => {
      ...
      expect(response.markup).toMatch(new RegExp(
        '<span ' + ROOT_ATTRIBUTE_NAME + '="" ' +
          ID_ATTRIBUTE_NAME + '="[^"]+">hello world</span>'
      ));
    });
    ...
    it('should generate comment markup for component returns null', () => {
      ...
      expect(response.markup).toBe('<!-- react-empty: 1 -->');
    });
    ...
    // TODO: this test requires ReactDefaultInjection
    xit('should have the correct mounting behavior', () => {
